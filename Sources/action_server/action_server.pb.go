...
const file_action_server_proto_rawDesc = "" +
	...
	"\fflight_modes\x18\x01 \x01(\v2..mavsdk.rpc.action_server.AllowableFlightModesR\vflightModes\" \n" +
	...
	"\fflight_modes\x18\x01 \x01(\v2..mavsdk.rpc.action_server.AllowableFlightModesR\vflightModes\"\x90\x01\n" +
	...
	"\x16FLIGHT_MODE_STABILIZED\x10\r2\x9d\f\n" +
	...
	"\x17GetAllowableFlightModes\x128.mavsdk.rpc.action_server.GetAllowableFlightModesRequest\x1a9.mavsdk.rpc.action_server.GetAllowableFlightModesResponse\"\x04\x80\xb5\x18\x01B$B\x11ActionServerProtoZ\x0f.;action_serverb\x06proto3"
