...
func (Odometry_MavFrame) EnumDescriptor() ([]byte, []int) {
	return file_telemetry_server_proto_rawDescGZIP(), []int{48, 0}
}
...
func (TelemetryServerResult_Result) EnumDescriptor() ([]byte, []int) {
	return file_telemetry_server_proto_rawDescGZIP(), []int{60, 0}
}
...
const file_telemetry_server_proto_rawDesc = "" +
	...
	"\x0fdistance_sensor\x18\x01 \x01(\v2+.mavsdk.rpc.telemetry_server.DistanceSensorR\x0edistanceSensor\"\x85\x01\n" +
	...
	"\flatitude_deg\x18\x01 \x01(\x01B\a\x82\xb5\x18\x03NaNR\vlatitudeDeg\x12,\n" +
	"\rlongitude_deg\x18\x02 \x01(\x01B\a\x82\xb5\x18\x03NaNR\flongitudeDeg\x127\n" +
	"\x13absolute_altitude_m\x18\x03 \x01(\x02B\a\x82\xb5\x18\x03NaNR\x11absoluteAltitudeM\"\xa5\x01\n" +
	...
	"\x0eclimb_rate_m_s\x18\x03 \x01(\x02B\a\x82\xb5\x18\x03NaNR\vclimbRateMS\"\x88\x01\n" +
	...
	"\x14LANDED_STATE_LANDING\x10\x042\xa3\x10\n" +
	...
	"\x15PublishDistanceSensor\x129.mavsdk.rpc.telemetry_server.PublishDistanceSensorRequest\x1a:.mavsdk.rpc.telemetry_server.PublishDistanceSensorResponse\"\x04\x80\xb5\x18\x01B*B\x14TelemetryServerProtoZ\x12.;telemetry_serverb\x06proto3"
...
var file_telemetry_server_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_telemetry_server_proto_goTypes = []any{
	...
	(*PublishPositionResponse)(nil),            // 24: mavsdk.rpc.telemetry_server.PublishPositionResponse
	(*PublishHomeResponse)(nil),                // 25: mavsdk.rpc.telemetry_server.PublishHomeResponse
	(*PublishSysStatusResponse)(nil),           // 26: mavsdk.rpc.telemetry_server.PublishSysStatusResponse
	(*PublishExtendedSysStateResponse)(nil),    // 27: mavsdk.rpc.telemetry_server.PublishExtendedSysStateResponse
	(*PublishRawGpsResponse)(nil),              // 28: mavsdk.rpc.telemetry_server.PublishRawGpsResponse
	(*PublishBatteryResponse)(nil),             // 29: mavsdk.rpc.telemetry_server.PublishBatteryResponse
	(*PublishStatusTextResponse)(nil),          // 30: mavsdk.rpc.telemetry_server.PublishStatusTextResponse
	(*PublishOdometryResponse)(nil),            // 31: mavsdk.rpc.telemetry_server.PublishOdometryResponse
	(*PublishPositionVelocityNedResponse)(nil), // 32: mavsdk.rpc.telemetry_server.PublishPositionVelocityNedResponse
	(*PublishGroundTruthResponse)(nil),         // 33: mavsdk.rpc.telemetry_server.PublishGroundTruthResponse
	(*PublishImuResponse)(nil),                 // 34: mavsdk.rpc.telemetry_server.PublishImuResponse
	(*PublishScaledImuResponse)(nil),           // 35: mavsdk.rpc.telemetry_server.PublishScaledImuResponse
	(*PublishRawImuResponse)(nil),              // 36: mavsdk.rpc.telemetry_server.PublishRawImuResponse
	(*PublishUnixEpochTimeResponse)(nil),       // 37: mavsdk.rpc.telemetry_server.PublishUnixEpochTimeResponse
	(*PublishDistanceSensorResponse)(nil),      // 38: mavsdk.rpc.telemetry_server.PublishDistanceSensorResponse
	(*Position)(nil),                           // 39: mavsdk.rpc.telemetry_server.Position
	(*Heading)(nil),                            // 40: mavsdk.rpc.telemetry_server.Heading
	(*Quaternion)(nil),                         // 41: mavsdk.rpc.telemetry_server.Quaternion
	(*EulerAngle)(nil),                         // 42: mavsdk.rpc.telemetry_server.EulerAngle
	(*AngularVelocityBody)(nil),                // 43: mavsdk.rpc.telemetry_server.AngularVelocityBody
	(*GpsInfo)(nil),                            // 44: mavsdk.rpc.telemetry_server.GpsInfo
	(*RawGps)(nil),                             // 45: mavsdk.rpc.telemetry_server.RawGps
	(*Battery)(nil),                            // 46: mavsdk.rpc.telemetry_server.Battery
	(*RcStatus)(nil),                           // 47: mavsdk.rpc.telemetry_server.RcStatus
	(*StatusText)(nil),                         // 48: mavsdk.rpc.telemetry_server.StatusText
	(*ActuatorControlTarget)(nil),              // 49: mavsdk.rpc.telemetry_server.ActuatorControlTarget
	(*ActuatorOutputStatus)(nil),               // 50: mavsdk.rpc.telemetry_server.ActuatorOutputStatus
	(*Covariance)(nil),                         // 51: mavsdk.rpc.telemetry_server.Covariance
	(*VelocityBody)(nil),                       // 52: mavsdk.rpc.telemetry_server.VelocityBody
	(*PositionBody)(nil),                       // 53: mavsdk.rpc.telemetry_server.PositionBody
	(*Odometry)(nil),                           // 54: mavsdk.rpc.telemetry_server.Odometry
	(*DistanceSensor)(nil),                     // 55: mavsdk.rpc.telemetry_server.DistanceSensor
	(*ScaledPressure)(nil),                     // 56: mavsdk.rpc.telemetry_server.ScaledPressure
	(*PositionNed)(nil),                        // 57: mavsdk.rpc.telemetry_server.PositionNed
	(*VelocityNed)(nil),                        // 58: mavsdk.rpc.telemetry_server.VelocityNed
	(*PositionVelocityNed)(nil),                // 59: mavsdk.rpc.telemetry_server.PositionVelocityNed
	(*GroundTruth)(nil),                        // 60: mavsdk.rpc.telemetry_server.GroundTruth
	(*FixedwingMetrics)(nil),                   // 61: mavsdk.rpc.telemetry_server.FixedwingMetrics
	(*AccelerationFrd)(nil),                    // 62: mavsdk.rpc.telemetry_server.AccelerationFrd
	(*AngularVelocityFrd)(nil),                 // 63: mavsdk.rpc.telemetry_server.AngularVelocityFrd
	(*MagneticFieldFrd)(nil),                   // 64: mavsdk.rpc.telemetry_server.MagneticFieldFrd
	(*Imu)(nil),                                // 65: mavsdk.rpc.telemetry_server.Imu
	(*TelemetryServerResult)(nil),              // 66: mavsdk.rpc.telemetry_server.TelemetryServerResult
}
var file_telemetry_server_proto_depIdxs = []int32{
	39, // 0: mavsdk.rpc.telemetry_server.PublishPositionRequest.position:type_name -> mavsdk.rpc.telemetry_server.Position
	58, // 1: mavsdk.rpc.telemetry_server.PublishPositionRequest.velocity_ned:type_name -> mavsdk.rpc.telemetry_server.VelocityNed
	40, // 2: mavsdk.rpc.telemetry_server.PublishPositionRequest.heading:type_name -> mavsdk.rpc.telemetry_server.Heading
	39, // 3: mavsdk.rpc.telemetry_server.PublishHomeRequest.home:type_name -> mavsdk.rpc.telemetry_server.Position
	46, // 4: mavsdk.rpc.telemetry_server.PublishSysStatusRequest.battery:type_name -> mavsdk.rpc.telemetry_server.Battery
	...
	45, // 8: mavsdk.rpc.telemetry_server.PublishRawGpsRequest.raw_gps:type_name -> mavsdk.rpc.telemetry_server.RawGps
	44, // 9: mavsdk.rpc.telemetry_server.PublishRawGpsRequest.gps_info:type_name -> mavsdk.rpc.telemetry_server.GpsInfo
	46, // 10: mavsdk.rpc.telemetry_server.PublishBatteryRequest.battery:type_name -> mavsdk.rpc.telemetry_server.Battery
	47, // 11: mavsdk.rpc.telemetry_server.PublishRcStatusRequest.rc_status:type_name -> mavsdk.rpc.telemetry_server.RcStatus
	48, // 12: mavsdk.rpc.telemetry_server.PublishStatusTextRequest.status_text:type_name -> mavsdk.rpc.telemetry_server.StatusText
	54, // 13: mavsdk.rpc.telemetry_server.PublishOdometryRequest.odometry:type_name -> mavsdk.rpc.telemetry_server.Odometry
	59, // 14: mavsdk.rpc.telemetry_server.PublishPositionVelocityNedRequest.position_velocity_ned:type_name -> mavsdk.rpc.telemetry_server.PositionVelocityNed
	60, // 15: mavsdk.rpc.telemetry_server.PublishGroundTruthRequest.ground_truth:type_name -> mavsdk.rpc.telemetry_server.GroundTruth
	65, // 16: mavsdk.rpc.telemetry_server.PublishImuRequest.imu:type_name -> mavsdk.rpc.telemetry_server.Imu
	65, // 17: mavsdk.rpc.telemetry_server.PublishScaledImuRequest.imu:type_name -> mavsdk.rpc.telemetry_server.Imu
	65, // 18: mavsdk.rpc.telemetry_server.PublishRawImuRequest.imu:type_name -> mavsdk.rpc.telemetry_server.Imu
	55, // 19: mavsdk.rpc.telemetry_server.PublishDistanceSensorRequest.distance_sensor:type_name -> mavsdk.rpc.telemetry_server.DistanceSensor
	66, // 20: mavsdk.rpc.telemetry_server.PublishPositionResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 21: mavsdk.rpc.telemetry_server.PublishHomeResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 22: mavsdk.rpc.telemetry_server.PublishSysStatusResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 23: mavsdk.rpc.telemetry_server.PublishExtendedSysStateResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 24: mavsdk.rpc.telemetry_server.PublishRawGpsResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 25: mavsdk.rpc.telemetry_server.PublishBatteryResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 26: mavsdk.rpc.telemetry_server.PublishStatusTextResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 27: mavsdk.rpc.telemetry_server.PublishOdometryResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 28: mavsdk.rpc.telemetry_server.PublishPositionVelocityNedResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 29: mavsdk.rpc.telemetry_server.PublishGroundTruthResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 30: mavsdk.rpc.telemetry_server.PublishImuResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 31: mavsdk.rpc.telemetry_server.PublishScaledImuResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 32: mavsdk.rpc.telemetry_server.PublishRawImuResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 33: mavsdk.rpc.telemetry_server.PublishUnixEpochTimeResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	66, // 34: mavsdk.rpc.telemetry_server.PublishDistanceSensorResponse.telemetry_server_result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult
	0,  // 35: mavsdk.rpc.telemetry_server.GpsInfo.fix_type:type_name -> mavsdk.rpc.telemetry_server.FixType
	2,  // 36: mavsdk.rpc.telemetry_server.StatusText.type:type_name -> mavsdk.rpc.telemetry_server.StatusTextType
	4,  // 37: mavsdk.rpc.telemetry_server.Odometry.frame_id:type_name -> mavsdk.rpc.telemetry_server.Odometry.MavFrame
	4,  // 38: mavsdk.rpc.telemetry_server.Odometry.child_frame_id:type_name -> mavsdk.rpc.telemetry_server.Odometry.MavFrame
	53, // 39: mavsdk.rpc.telemetry_server.Odometry.position_body:type_name -> mavsdk.rpc.telemetry_server.PositionBody
	41, // 40: mavsdk.rpc.telemetry_server.Odometry.q:type_name -> mavsdk.rpc.telemetry_server.Quaternion
	52, // 41: mavsdk.rpc.telemetry_server.Odometry.velocity_body:type_name -> mavsdk.rpc.telemetry_server.VelocityBody
	43, // 42: mavsdk.rpc.telemetry_server.Odometry.angular_velocity_body:type_name -> mavsdk.rpc.telemetry_server.AngularVelocityBody
	51, // 43: mavsdk.rpc.telemetry_server.Odometry.pose_covariance:type_name -> mavsdk.rpc.telemetry_server.Covariance
	51, // 44: mavsdk.rpc.telemetry_server.Odometry.velocity_covariance:type_name -> mavsdk.rpc.telemetry_server.Covariance
	57, // 45: mavsdk.rpc.telemetry_server.PositionVelocityNed.position:type_name -> mavsdk.rpc.telemetry_server.PositionNed
	58, // 46: mavsdk.rpc.telemetry_server.PositionVelocityNed.velocity:type_name -> mavsdk.rpc.telemetry_server.VelocityNed
	62, // 47: mavsdk.rpc.telemetry_server.Imu.acceleration_frd:type_name -> mavsdk.rpc.telemetry_server.AccelerationFrd
	63, // 48: mavsdk.rpc.telemetry_server.Imu.angular_velocity_frd:type_name -> mavsdk.rpc.telemetry_server.AngularVelocityFrd
	64, // 49: mavsdk.rpc.telemetry_server.Imu.magnetic_field_frd:type_name -> mavsdk.rpc.telemetry_server.MagneticFieldFrd
	5,  // 50: mavsdk.rpc.telemetry_server.TelemetryServerResult.result:type_name -> mavsdk.rpc.telemetry_server.TelemetryServerResult.Result
	6,  // 51: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishPosition:input_type -> mavsdk.rpc.telemetry_server.PublishPositionRequest
	7,  // 52: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishHome:input_type -> mavsdk.rpc.telemetry_server.PublishHomeRequest
	8,  // 53: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishSysStatus:input_type -> mavsdk.rpc.telemetry_server.PublishSysStatusRequest
	9,  // 54: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishExtendedSysState:input_type -> mavsdk.rpc.telemetry_server.PublishExtendedSysStateRequest
	12, // 55: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishRawGps:input_type -> mavsdk.rpc.telemetry_server.PublishRawGpsRequest
	13, // 56: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishBattery:input_type -> mavsdk.rpc.telemetry_server.PublishBatteryRequest
	15, // 57: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishStatusText:input_type -> mavsdk.rpc.telemetry_server.PublishStatusTextRequest
	16, // 58: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishOdometry:input_type -> mavsdk.rpc.telemetry_server.PublishOdometryRequest
	17, // 59: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishPositionVelocityNed:input_type -> mavsdk.rpc.telemetry_server.PublishPositionVelocityNedRequest
	18, // 60: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishGroundTruth:input_type -> mavsdk.rpc.telemetry_server.PublishGroundTruthRequest
	19, // 61: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishImu:input_type -> mavsdk.rpc.telemetry_server.PublishImuRequest
	20, // 62: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishScaledImu:input_type -> mavsdk.rpc.telemetry_server.PublishScaledImuRequest
	21, // 63: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishRawImu:input_type -> mavsdk.rpc.telemetry_server.PublishRawImuRequest
	22, // 64: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishUnixEpochTime:input_type -> mavsdk.rpc.telemetry_server.PublishUnixEpochTimeRequest
	23, // 65: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishDistanceSensor:input_type -> mavsdk.rpc.telemetry_server.PublishDistanceSensorRequest
	24, // 66: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishPosition:output_type -> mavsdk.rpc.telemetry_server.PublishPositionResponse
	25, // 67: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishHome:output_type -> mavsdk.rpc.telemetry_server.PublishHomeResponse
	26, // 68: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishSysStatus:output_type -> mavsdk.rpc.telemetry_server.PublishSysStatusResponse
	27, // 69: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishExtendedSysState:output_type -> mavsdk.rpc.telemetry_server.PublishExtendedSysStateResponse
	28, // 70: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishRawGps:output_type -> mavsdk.rpc.telemetry_server.PublishRawGpsResponse
	29, // 71: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishBattery:output_type -> mavsdk.rpc.telemetry_server.PublishBatteryResponse
	30, // 72: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishStatusText:output_type -> mavsdk.rpc.telemetry_server.PublishStatusTextResponse
	31, // 73: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishOdometry:output_type -> mavsdk.rpc.telemetry_server.PublishOdometryResponse
	32, // 74: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishPositionVelocityNed:output_type -> mavsdk.rpc.telemetry_server.PublishPositionVelocityNedResponse
	33, // 75: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishGroundTruth:output_type -> mavsdk.rpc.telemetry_server.PublishGroundTruthResponse
	34, // 76: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishImu:output_type -> mavsdk.rpc.telemetry_server.PublishImuResponse
	35, // 77: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishScaledImu:output_type -> mavsdk.rpc.telemetry_server.PublishScaledImuResponse
	36, // 78: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishRawImu:output_type -> mavsdk.rpc.telemetry_server.PublishRawImuResponse
	37, // 79: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishUnixEpochTime:output_type -> mavsdk.rpc.telemetry_server.PublishUnixEpochTimeResponse
	38, // 80: mavsdk.rpc.telemetry_server.TelemetryServerService.PublishDistanceSensor:output_type -> mavsdk.rpc.telemetry_server.PublishDistanceSensorResponse
